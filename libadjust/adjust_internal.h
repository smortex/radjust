...
int			 send_file(struct file_info *info, const char *remote_filename) __attribute__((warn_unused_result));
int			 recv_file(const char *filename) __attribute__((warn_unused_result));
